...
import type { ApiResponse, RegistrationInput, RegistrationResponse } from '../../lib/api/types/registration';
...
import { sendVerificationEmail } from '../../lib/api/services/email';
